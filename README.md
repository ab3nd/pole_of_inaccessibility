...
If you consider roads and trails, the pole of inaccesasbility is https://maps.app.goo.gl/it2NyhXJNtboS9kG9 (44°33'16.2"N 71°27'12.9"W). It's due west of the Unknown Pond Trailhead by almost exactly 2 miles, or 1.35 miles from the end of Millbrook Road (According to Google Maps. I doubt Millbrook Road is a thing you can actually drive on for its entire length). It looks like the point is near the ridgeline of the formation that includes Cabot and Waumbek, but not quite on it. 
